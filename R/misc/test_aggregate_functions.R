...
test_that("calc_sparse_correlation works for sparse method", {
  
  set.seed(1)
  mat <- Matrix::rsparsematrix(10, 10, density = 0.1)
  result <- calc_sparse_correlation(mat, cor_method = "sparse")
...
test_that("calc_sparse_correlation works for pearson method", {
  
  mat <- matrix(rnorm(100), nrow = 10, ncol = 10)
  result <- calc_sparse_correlation(mat, cor_method = "pearson")
...
test_that("calc_sparse_correlation works for spearman method", {
  
  mat <- matrix(rnorm(100), nrow = 10, ncol = 10)
  result <- calc_sparse_correlation(mat, cor_method = "spearman")
...
test_that("calc_sparse_correlation handles NAs correctly for sparse method", {
...
test_that("calc_sparse_correlation throws an error for sparse matrix with dense method", {
  mat <- Matrix::rsparsematrix(10, 10, density = 0.1)
  expect_error(calc_sparse_correlation(mat, cor_method = "pearson"))
})



test_that("calc_sparse_correlation throws an error for dense matrix with sparse method", {
  mat <- matrix(rnorm(100), nrow = 10)
  expect_error(calc_sparse_correlation(mat, cor_method = "sparse"))
})
