...
aggr_path <- file.path(out_dir, "aggtools_aggregate_matrix_fishersz.tsv")
na_path <- file.path(out_dir, "aggtools_NA_matrix_fishersz.tsv")
...
aggr_l <- aggr_coexpr_multi_dataset(
  input_df = ct_df,
  pc_df = pc_df,
  cor_method = "pearson",
  agg_method = "FZ"
