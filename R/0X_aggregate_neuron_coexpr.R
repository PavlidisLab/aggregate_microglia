...
rsr_path_hg <- "/space/scratch/amorin/aggregate_microglia/Cormats/Neuron_hg/aggregate_cormat_RSR_neuron_hg.RDS"
rsr_path_mm <- "/space/scratch/amorin/aggregate_microglia/Cormats/Neuron_mm/aggregate_cormat_RSR_neuron_mm.RDS"
